var AsciinemaPlayer = (function (A) {
      ...
      A.observers &&
        ...
        b(() => {
          for (let g = 0; g < A.observers.length; g += 1) {
            ...
            B,
              I.state || (I.pure ? h.push(I) : l.push(I), I.observers && x(I)),
              (I.state = 1);
          }
    ...
    (w = u = A),
      (function (A, g, I) {
        ...
        (!A.updatedAt || A.updatedAt <= I) &&
          (A.observers && A.observers.length ? S(A, B) : (A.value = B),
          (A.updatedAt = I));
      })(A, A.value, B),
      (w = I),
      (u = g);
  ...
  function K(A) {
    ...
    if (A.suspense && M(A.suspense.inFallback))
  ...
  function x(A) {
    for (let g = 0; g < A.observers.length; g += 1) {
      const I = A.observers[g];
      I.state ||
        ((I.state = 2), I.pure ? h.push(I) : l.push(I), I.observers && x(I));
    }
  }
  function j(A) {
    let g;
  ...
  function lA() {
    return (
      (null !== hA && hA.buffer === rA.memory.buffer) ||
  ...
  function MA() {
    return (
      (null !== FA && FA.buffer === rA.memory.buffer) ||
        (FA = new Int32Array(rA.memory.buffer)),
      FA
    );
  }
  var RA = null;
            ...
            switch ((A.prev = A.next)) {
              case 0:
                return (
                  ...
                  (I.wbg.__wbg_BigInt_1b7cf17b993da2bd = function (A, g) {
                    (LA[0] = A), (LA[1] = g);
                    var I = YA[0];
                    return wA(BigInt(I));
                  }),
                  ...
                  (I.wbg.__wbg_set_fbb49ad265f9dee8 = function (A, g, I) {
                    aA(A)[uA(g)] = uA(I);
                  }),
  ...
  function _A(A, g = new Set()) {
    ...
    if (Array.isArray(A)) {
      ...
      for (let t = 0, e = I.length; t < e; t++)
        (C = I[t]),
          E[C].get || ((Q = A[C]), (B = _A(Q, g)) !== Q && (A[C] = B));
    }
    return A;
  }
  function $A(A) {
  ...
  const gg = {
    get(A, g, I) {
      ...
      const Q = zA(B);
      if (L() && ('function' != typeof B || A.hasOwnProperty(g))) {
        let I, C;
  ...
  function Cg(A, g, I, B, Q) {
    const C = g[I];
    if (A === C) return;
    if (!zA(A) || !zA(C) || (Q && A[Q] !== C[Q]))
      return void (A !== C && Ig(g, I, A));
    if (Array.isArray(A)) {
    ...
    for (let g = 0, I = t.length; g < I; g++)
      void 0 === A[t[g]] && Ig(C, t[g], void 0);
  }
  function Eg(A, g = {}) {
    const { merge: I, key: B = 'id' } = g,
      Q = _A(A);
    return (A) =>
      zA(A) && zA(Q) ? (Cg(Q, { state: A }, 'state', I, B), A) : Q;
  }
  const tg = IA('<span></span>');
  var eg = function (A) {
    return (
      EA((g = tg.cloneNode(!0)), function () {
        return A.text;
      }),
      k(
        function (I) {
  ...
  var lg = function (A) {
    var g,
      ...
      t = function () {
        return 'number' == typeof A.currentTime ? hg(A.currentTime) : '--:--';
      },
      e = function () {
              ...
              switch ((A.prev = A.next)) {
                case 0:
                  return (
                    ...
                    (o = new ResizeObserver(function (A) {
                      u({
                        containerW: E.offsetWidth,
                        containerH: E.offsetHeight,
                      }),
                        E.dispatchEvent(
                          new CustomEvent('resize', { detail: { el: e } })
                        );
                    })).observe(E),
                    (A.next = 5),
                    r.init()
              ...
              switch ((g.prev = g.next)) {
                ...
                case 5:
                  if (
                    ...
                    (C = B.rows),
                    (D =
                      null !== (I = D) && void 0 !== I ? I : B.idleTimeLimit),
                    (n = Yg(B.frames, D, h)),
                    0 !== (E = n.frames).length)
                  ) {
                    g.next = 14;
  ...
  function pg(A) {
    ...
    if (1 === g.version)
      return (function (A) {
        var g = 0,
          I = new Fg(A.stdout).map(function (A) {
            return [(g += A[0]), A[1]];
          });
      ...
      ((I = new WebSocket(Q)).binaryType = 'arraybuffer'),
        ...
        (I.onclose = function (A) {
          s || 1e3 === A.code || 1005 === A.code
            ...
            : (console.debug(
                'websocket: unclean close, reconnecting in '.concat(r, '...')
              ),
              i(!0),
              setTimeout(c, r),
              (r = Math.min(2 * r, 5e3)));
