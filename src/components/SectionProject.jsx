...
import { GameBtn } from './GameBtn.jsx'
import { LinkedinBtn } from './LinkedinBtn.jsx'
import { Slider } from './Splider.jsx'
import { GradienText } from './GradientText.jsx'
                                    ...
                                    <div className="text-4xl">
                                        <div className="inline-flex">
                                            {props.technologies.map((tech) => (
                                                <em
                                                    className={`stroke-emerald-900 ${tech.toLowerCase()} colored mr-2 transition ease-in-out hover:scale-110 hover:-translate-y-1.5 duration-100`}
                                                ></em>
                                            ))}
                                        </div>
                                    </div>
